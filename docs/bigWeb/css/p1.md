...
### 2.展示指定元素的指定属性内容
![图片](http://img.cdn.sugarat.top/mdImg/MTU4MjExNjI1Mzg0OQ==582116253849)
```html
...
### 3.附加图片icon
![图片](http://img.cdn.sugarat.top/mdImg/MTU4MjExNzE5MjM3Ng==582117192376)
```html
<i class="icon"></i>
```
```css
.icon::after{
    content: url(http://img.cdn.sugarat.top/mdImg/MTU4MjExNzE5MjM3Ng==582117192376);
    width: 20px;
    height: 20px;
    display: block;
}
