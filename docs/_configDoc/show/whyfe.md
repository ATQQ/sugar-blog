...
CS，JS，css,html,工程能力 开发能力
### 5. 前端学习如何可以快速做出一个项目（学什么）
希望快速得到结果：
了解一下html,css怎么用如何书写（用的时候查）,就可以开发一个简单的页面

如果希望丰富的交互 js的简单语法，根据自己想要的查一下BOM，DOM API
...
* 小程序厂商的开发规则自定的，但还是用的 类html，css，js js编写规则得按它提供的文档
...
* CS
* 后端 Node js 或者其它
* 几多不亚盛，你会别人不会 这就是你的优势，我相信你也不满足于值写静态页面
* 需要，关系 非关系
### 8. 进入大厂需要准备什么以前端来说，比如项目，或者奖，是必要的吗
* 项目
* 奖：ACM，普通程序设计，果奖蓝桥杯，PTA
